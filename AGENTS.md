...
- 新增 `services/telegram/src/liuyao_factors/`：以 divicast 为底层，统一输出六爻原始盘面并映射为量化因子，便于后续统计分析与回测。
...
sys.path.insert(0, "/path/to/project/libs")
```
